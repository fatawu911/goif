...
const Hero = ({ slides, autoPlay = true, interval = 5000 }: HeroProps) => {
    ...
    >
        ...
        >
          ...
          <div className="relative h-full container mx-auto px-4 lg:px-8 flex items-center">
            <div className="max-w-3xl text-primary-foreground">
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold mb-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                {slide.title}
              </h1>
      ...
      {slides.length > 1 && (
        <>
          <button
            onClick={prevSlide}
            className="absolute left-4 bottom-9 -translate-y-1/2 w-12 h-12 rounded-full bg-background/20 
            backdrop-blur-sm hover:bg-background/40 text-primary-foreground flex items-center justify-center 
          ...
          <button
            onClick={nextSlide}
            className="absolute right-4 bottom-9 -translate-y-1/2 w-12 h-12 rounded-full bg-background/20 
            backdrop-blur-sm hover:bg-background/40 text-primary-foreground flex items-center justify-center 
            transition-all duration-300 hover:scale-110"
