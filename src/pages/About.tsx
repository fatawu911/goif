  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-10 bg-primary text-primary-foreground">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary-foreground">Our Impacts</h2>
        </div>
          <div className="container mx-auto px-4 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-7 gap-3 text-center">
              {[
                { number: "20+", label: "Projects Completed" },
                { number: "460+", label: "Editors" },
                { number: "6.10K+", label: "Articles Edited" },
                { number: "3.70K+", label: "Articles Created" },
                { number: "2.40K+", label: "Commons Uploads" },
                { number: "34.7K+", label: "Total revisions" },
                { number: "3.06K+", label: "Items Created" },
              ].map((stat, index) => (
                <div key={index}>
                  <div className="text-4xl md:text-3xl font-bold mb-2 text-secondary">{stat.number}</div>
